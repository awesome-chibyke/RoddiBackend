...
class LoginAuthModel {
    ...
    async selectAllLoginAuthWhere(conditions, filterDeletedRow = 'yes', destroy = "no", orderByColumns = 'id', orderByDirection = 'desc'){
        ////[["unique_id", "=", Currency]]
        let allUsers = await this.DbActions.selectBulkData("login_table", {filteringConditions: conditions}, filterDeletedRow, destroy, orderByColumns, orderByDirection);
        return allUsers;
    }

    async selectAllLoginAuth(conditions = [], filterDeletedRows = 'yes', destroy = "no", orderByColumns = 'id', orderByDirection = 'desc'){
        ////[["unique_id", "=", Currency]]
        let allUsers = await this.DbActions.selectAllData("login_table", {
