...
>
    ...
    padding-bottom: 10px; border-bottom: 2px solid #1B1717; background: url(${$settingsObj.site_url+'/email_files/background-landscape.png'}); background-position: center; background-size: cover;"
                                        >
                                            ...
                                            <h3 align="center">WELCOME TO ${$settingsObj.site_name.toUpperCase()}</h3>
                                            <div align="center">
                                                <img
    ...
    "
                                        >
                                            You have successfully uploaded your form of Identification Document to ${$settingsObj.site_name.toUpperCase()}. Please wait for a while as this documnet is under review. We will get back to you once we are done with the review.
                                        </p>
                                        <table
                                                border="0"
                                                cellpadding="0"
    ...
    "
                                        ...
                                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">We are glad and pleased to have you on board, feel free to explore our platform and enjoy our services
                                        </p>
...
module.exports = IdUploadSuccessTemplate;
