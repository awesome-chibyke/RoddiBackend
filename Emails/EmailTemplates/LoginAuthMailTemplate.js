                                                                                                        ...
                                                                                                        <tbody>
                                                                                                            ...
                                                                                                            <tr>
                                                                                                                ...
                                                                                                                <td style="vertical-align: top; padding: 30px 0 0 0; text-align: center;"
                                                                                                                    valign="top"
                                                                                                                    align="center">
                                                                                                                    <img src="${site_url}/images/5844.jpg"
                                                                                                                        width="346"
                                                                                                                        height="277"
                                                                                                                        alt=""
                                                                                                                        ...
                                                                                                                        <tbody>
                                                                                                                            <tr>
                                                                                                                                <td style="vertical-align: top; border-radius: 8px; text-align: center; background-color: #1595E7;"
                                                                                                                                    ...
                                                                                                                                    align="center">
                                                                                                                                    <a href="javascrip:;"
                                                                                                                                        style="line-height: 1.5; text-decoration: none; margin: 0; padding: 13px 17px; white-space: nowrap; border-radius: 8px; font-weight: 500; display: inline-block; font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 16px; cursor: pointer; background-color: #1595E7; color: #ffffff; border: 1px solid #1595E7;">${activationCode}</a>
                                                                                                                                </td>
                                                                                                                            </tr>
                                                                                                                        </tbody>
                                                                                                                    </table>
                                                                        ...
                                                                        <tbody>
                                                                            <tr>
                                                                                <td class="pc-cta-box-in"
                                                                                    style="vertical-align: top; padding: 40px 30px 32px;"
                                                                                    valign="top">
...
module.exports = LoginAuthTemplate;
