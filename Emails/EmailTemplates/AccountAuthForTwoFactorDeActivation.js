const AccountAuthForTwoFactorDeactivation = (
    fullName,
    subject,
    $settingsObj,
    token
...
>
    ...
    "
                                        >
                                            We have received a 2-factor deactivation request from your account with ${$settingsObj.site_name}. Below is a four digit code for account authentication.
                                        </p>
                                        <table
                                                border="0"
                                                cellpadding="0"
...
module.exports = AccountAuthForTwoFactorDeactivation;
