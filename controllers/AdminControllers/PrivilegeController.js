  ...
  async storePrivilege(req, res) {
    try {
      ...
      for (let i in rolesManagement) {
        ...
        let selectedPrivilege = await this.Priviledges.returnPriviledge(
          privilegeArray,
          rolesManagement[i],
          rolesManagement[i]
        );
        ...
        if (selectedPrivilege.privilege_object !== null) {
          ...
          existingRoleManagementObject.privileges[count].status =
            rolesManagement[i].status;
        } else {
          ...
          existingRoleManagementObject.privileges.push(
